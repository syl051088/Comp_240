/*
 * Task 1: testing out functions found in hex.c and binary_convert.c Joseph
 */ 
...
int main() {
	...
	bin_str = nibble_to_bin_str(16);
	printf("The value of 16 is %s\n", bin_str);
	free(bin_str);                                         // uncomment and use after first test
	
	//add lines for second test
	bin_str = nibble_to_bin_str(-1);
